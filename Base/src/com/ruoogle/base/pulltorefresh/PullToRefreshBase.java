package com.ruoogle.base.pulltorefresh;

import com.ruoogle.base.R;
import com.ruoogle.base.pulltorefresh.internal.LoadingLayout;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		String pullLabel = context.getString(R.string.Str_Base_Pull_To_Refresh_Pull);
		String refreshingLabel = context.getString(R.string.Str_Base_Pull_To_Refresh_Refreshing);
		String releaseLabel = context.getString(R.string.Str_Base_Pull_To_Refresh_Release);
